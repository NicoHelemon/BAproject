...
ap.add_argument("-i", "--image", type=str,
	default=os.path.sep.join(["images", "smol_dog.jpg"]),
...
#cv2.imshow("adrian", image)
#cv2.waitKey(0)
#cv2.destroyAllWindows()

# define (manually) the bounding box coordinates that approximately define my
# face and neck region (i.e., all visible skin)
# rect = (90, 25, 130, 210) #adrian rect
rect = (45, 5, 460, 520) #smol_dog rect
